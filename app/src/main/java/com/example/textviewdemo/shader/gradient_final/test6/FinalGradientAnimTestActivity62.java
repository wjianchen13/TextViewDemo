 ...
 * 1.彩虹，需要支持滚动
 */
public class FinalGradientAnimTestActivity62 extends AppCompatActivity {

    private RecyclerView rvGradientAnim;
    private List<FinalTestBean6> mList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_final_gradient_anim_test62);
    ...
    private void initRv() {
        ...
        FinalTestAdapter6 adapter = new FinalTestAdapter6(this, mList);
    ...
    private FinalTestBean6 getTextBean() {
        FinalTestBean6 bean = new FinalTestBean6();
        bean.setContent("测试数据: " + (i ++));
        bean.setItemType(FinalTestAdapter6.TYPE_TEXT);
        return bean;
    }

    private FinalTestBean6 getTest1() {
        FinalTestBean6 bean = new FinalTestBean6();
        ...
        sContent.append(" ");
        bean.setItemType(FinalTestAdapter6.TYPE_GRADIENT);
        bean.setsContent(sContent);
        return bean;
    }

    private FinalTestBean6 getTest2() {
        FinalTestBean6 bean = new FinalTestBean6();
        SpannableStringBuilder sContent = new SpannableStringBuilder();
        sContent.append(getGradientAnimText(this, "سجل ABمعركة BBالفريقCC", colors, sContent.length(), 1800)); // 18  32
    ...
    private FinalTestBean6 getTest3() {
        FinalTestBean6 bean = new FinalTestBean6();
        bean.setItemType(FinalTestAdapter6.TYPE_GRADIENT);
        SpannableStringBuilder sContent = new SpannableStringBuilder();
        int[] colors = new int[] {
    ...
    private FinalTestBean6 getTest4() {
        FinalTestBean6 bean = new FinalTestBean6();
        bean.setItemType(FinalTestAdapter6.TYPE_GRADIENT);
        SpannableStringBuilder sContent = new SpannableStringBuilder();
        int[] colors = new int[] {
