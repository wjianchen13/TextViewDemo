 ...
 * 测试
 */
public class FinalTestAdapter4 extends BaseMultiItemQuickAdapter<FinalTestBean4, BaseViewHolder> {
    ...
    @Override
    protected void convert(BaseViewHolder helper, FinalTestBean4 item) {
        if (item == null) {
            return;
        }
