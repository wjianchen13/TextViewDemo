 ...
 * TextView 测试
 */
public class TextViewTestActivityV2 extends AppCompatActivity {

    private TestTextViewV2 tvTest;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_textview_test_v2);
    ...
    public void onTest1(View v) {
        ...
        sContent.append(ShaderUtils.getSizeText(this, "hello ", R.dimen.dp_20));
        int[] colors = new int[] {
