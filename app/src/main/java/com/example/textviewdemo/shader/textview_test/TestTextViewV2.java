 ...
 * 直接start = 0 end = width
 */
public class TestTextViewV2 extends AppCompatTextView {
    ...
    public TestTextViewV2(Context context) {
        super(context);
    }

    public TestTextViewV2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;

    }

    public TestTextViewV2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
