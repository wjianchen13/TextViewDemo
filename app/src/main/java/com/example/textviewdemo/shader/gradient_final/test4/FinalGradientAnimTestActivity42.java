 ...
 * 列表使用
 */
public class FinalGradientAnimTestActivity42 extends AppCompatActivity {

    private RecyclerView rvGradientAnim;
    private List<FinalTestBean4> mList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_final_gradient_anim_test42);
    ...
    private void initRv() {
        ...
        FinalTestAdapter4 adapter = new FinalTestAdapter4(this, mList);
    ...
    private FinalTestBean4 getTextBean() {
        FinalTestBean4 bean = new FinalTestBean4();
        bean.setContent("测试数据: " + (i ++));
        bean.setItemType(FinalTestAdapter4.TYPE_TEXT);
        return bean;
    }

    private FinalTestBean4 getTest1() {
        FinalTestBean4 bean = new FinalTestBean4();
        ...
        sContent.append(" ");
        bean.setItemType(FinalTestAdapter4.TYPE_GRADIENT);
        bean.setsContent(sContent);
        return bean;
    }

    private FinalTestBean4 getTest2() {
        FinalTestBean4 bean = new FinalTestBean4();
        SpannableStringBuilder sContent = new SpannableStringBuilder();
        sContent.append(getGradientAnimText(this, "سجل ABمعركة BBالفريقCC", colors, sContent.length(), 1800)); // 18  32
    ...
    private FinalTestBean4 getTest3() {
        FinalTestBean4 bean = new FinalTestBean4();
        bean.setItemType(FinalTestAdapter4.TYPE_GRADIENT);
        SpannableStringBuilder sContent = new SpannableStringBuilder();
        sContent.append(getSizeText(this, "hello ni hao ya!!", R.dimen.dp_20));
    ...
    private FinalTestBean4 getTest4() {
        FinalTestBean4 bean = new FinalTestBean4();
        bean.setItemType(FinalTestAdapter4.TYPE_GRADIENT);
        SpannableStringBuilder sContent = new SpannableStringBuilder();
        sContent.append(getSizeText(this, "hello ni hao ya!!", R.dimen.dp_20));
